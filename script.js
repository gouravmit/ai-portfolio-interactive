...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor("AI-First software engineer with over 5 years of    ", "#ffffff")}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor("experience building scalable full-stack applications.", "#ffffff")}
${this.wrapWithColor("└─────────────────────────────────────────────────────────┘", "#ff8c00")}

${this.wrapWithColor("⚡ Experience", "#ff8c00")}
${this.wrapWithColor("   Building scalable and efficient software solutions using", "#ffffff")}
${this.wrapWithColor("   Python, React, and Generative AI", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor("   Leveraging LLMs and Prompt Engineering to automate", "#ffffff")}
${this.wrapWithColor("   workflows and accelerate development timelines", "#ffffff")}

${this.wrapWithColor("⚡ Strengths", "#ff8c00")}
${this.wrapWithColor("   Strong backend systems, API design, and a genuine", "#ffffff")}
${this.wrapWithColor("   enthusiasm for creating impactful solutions", "#ffffff")}

${this.wrapWithColor("╭───────────────────────────────────────────────────────╮", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor("Ready to bring your innovative ideas to life!", "#ffffff")} ${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("╰───────────────────────────────────────────────────────╯", "#ff8c00")}`;
...
<span style="color: #00ffff;">IDS INFOTECH LTD. | Software Engineer</span>
${this.wrapWithColor("Jan 2021 - Present | Chandigarh, India", "#ffffff")}

• ${this.wrapWithColor("Key Contributor", "#ffa07a")} - ${this.wrapWithColor("Best Team of the Quarter.", "#ffffff")}
• ${this.wrapWithColor("AI-Driven Development", "#ffa07a")} - ${this.wrapWithColor("Recognized with Lovable.dev Excellence Award.", "#ffffff")}
• ${this.wrapWithColor("Full-Stack Development", "#ffa07a")} - ${this.wrapWithColor("Built multiple scalable full-stack applications.", "#ffffff")}
• ${this.wrapWithColor("Automation", "#ffa07a")} - ${this.wrapWithColor("Leveraged Python and AI to automate business processes.", "#ffffff")}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor("Python, React, FastAPI, Django, OpenAI API, PostgreSQL, AWS S3", "#87cefa")}`;
...
${this.wrapWithColor("┌──────────────────────────────────────────────────┐", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(" B.Tech in Computer Science (IT)                  ", "#ffffff")}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("└──────────────────────────────────────────────────┘", "#ff8c00")}

${this.wrapWithColor("🏛️ Institution:", "#ff8c00")} ${this.wrapWithColor("UPES", "#ffffff")}
${this.wrapWithColor("📅 Duration:", "#ff8c00")}    ${this.wrapWithColor("2015 - 2019", "#ffffff")}
${this.wrapWithColor("📍 Location:", "#ff8c00")}    ${this.wrapWithColor("Dehradun, India", "#ffffff")}

${this.wrapWithColor("╭──────────────────────────────────────────────────╮", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(" Foundation of my software engineering journey    ", "#ffffff")}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("╰──────────────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">🛠️ TECHNOLOGIES</span>
...
• ${this.wrapWithColor("Generative AI", "#ffffff")}
• ${this.wrapWithColor("OpenAI API", "#ffffff")}
• ${this.wrapWithColor("Prompt Engineering", "#ffffff")}
• ${this.wrapWithColor("PostgreSQL", "#ffffff")}
• ${this.wrapWithColor("AWS S3", "#ffffff")}`;
...
${this.wrapWithColor("┌────────────────────────────────────────┐", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor("Let's connect and create something great!", "#ffffff")} ${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("└────────────────────────────────────────┘", "#ff8c00")}

${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor("Email:", "#ff8c00")} ${this.wrapWithColor('<a href="mailto:mittalgm007@gmail.com" style="color: #ffffff; text-decoration: none;">mittalgm007@gmail.com</a>', "#ffffff")}

${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor("Github:", "#ff8c00")} ${this.wrapWithColor('<a href="#" target="_blank" style="color: #ffffff; text-decoration: none;">#</a>', "#ffffff")}

${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor("LinkedIn:", "#ff8c00")} ${this.wrapWithColor('<a href="#" target="_blank" style="color: #ffffff; text-decoration: none;">#</a>', "#ffffff")}

${this.wrapWithColor("╭────────────────────────────────────────╮", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor("Feel free to reach out for opportunities!", "#ffffff")} ${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
    ...
    this.projects = [
      {
        ...
        description: "AI-powered mock interview platform using OpenAI API.",
      ...
      },
      {
        ...
        description: "LLM-driven app analyzing startup ideas.",
        image: "image/placeholder.png",
